...
%% l6e+l6f operationally equivalent to entailed(U>=V).
l6e @ [X,U|L1] lex [Y,V|L2] <=> U==V, L1=[_|_] | [X,U] lex [Y,V], [X|L1] lex [Y|L2].
l6f @ bi(U>=V) \ [X,U|L1] lex [Y,V|L2] <=> L1=[_|_] | [X,U] lex [Y,V], [X|L1] lex [Y|L2].
%% or just ignore the entailed(U>=V)?
%% l6e @ [X,U|L1] lex [Y,V|L2] <=> L1=[_|_] | [X,U] lex [Y,V], [X|L1] lex [Y|L2].
